...
const Signup = () => {
  ...
  return (
    /* ... your existing JSX ... */
    <section className="min-h-screen w-full flex items-center justify-center  bg-linear-to-br from-[#EEF2FF] to-[#FCE7F3] p-8 text-slate-800 font-sans">
      <div className="flex flex-col md:flex-row w-full max-w-sm md:max-w-4xl bg-white rounded-2xl shadow-2xl overflow-hidden border border-gray-100 md:h-130">
        ...
        <div className="hidden md:flex flex-col w-24 lg:w-32 bg-gray-50 border-r border-gray-100 py-20 items-center relative">
          ...
          <div
            className="absolute left-0 w-1 bg-[#4C5BD4]
text-[#4C5BD4] transition-all duration-500 rounded-r-full top-55 h-12"
          />
          <Link
            to="/login"
          ...
          <Link
            to="/signup"
            className="flex flex-col items-center gap-2 text-[#4C5BD4]"
          >
        ...
        <div className="hidden md:flex flex-1 bg-linear-to-br from-[#90a9fd] to-[#faafd9] relative overflow-hidden items-center justify-center">
          <div className="absolute flex flex-col items-center p-10 text-white text-center">
            ...
            <img
              src={signupImg}
              className="w-64 mt-8 drop-shadow-xl"
              alt="hero"
            />
          </div>
        </div>
...
hover:bg-[#2639cc6f]  rounded-xl font-bold text-white shadow-lg mt-2 hover:scale-105 transition-transform"
              >
                SIGN UP
              </button>
              ...
              <p className="text-sm text-slate-500 text-center">
                ...
                <Link
                  to="/login"
                  className="text-[#4C5BD4] font-bold hover:underline"
                >
                  Sign In
                </Link>
              </p>
